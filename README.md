...
_See code: [dist/commands/create/index.ts](https://github.com/hdntecnologiabr/hdn-kombi-cli/blob/v0.0.5-beta/dist/commands/create/index.ts)_
...
_See code: [dist/commands/test.ts](https://github.com/hdntecnologiabr/hdn-kombi-cli/blob/v0.0.5-beta/dist/commands/test.ts)_
<!-- commandsstop -->
