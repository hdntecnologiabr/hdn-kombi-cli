...
running command...
$ kombi (--version)
kombi-cli/0.0.18-beta linux-x64 node-v16.14.0
$ kombi --help [COMMAND]
USAGE
  $ kombi COMMAND
...
...
_See code: [dist/commands/create/index.ts](https://github.com/hdntecnologiabr/hdn-kombi-cli/blob/v0.0.18-beta/dist/commands/create/index.ts)_
